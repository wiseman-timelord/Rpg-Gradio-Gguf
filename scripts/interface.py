...
def reset_session():
    ...
    temporary.scene_location = read_config.get('scene_location', 'Default Location')  # New key loaded
...
def update_keys(new_threads_percent=None, new_agent_name=None, new_agent_role=None, new_human_name=None, new_scene_location=None, new_session_history=None, new_image_size=None, new_steps_used=None, new_sample_method=None):
    ...
    if new_human_name is not None:
        temporary.human_name = new_human_name
    if new_scene_location is not None:
        temporary.scene_location = new_scene_location  # Store as string
            ...
            with gr.Tab("Configuration"):
                ...
                with gr.Row():
                    with gr.Column():
                        ...
                        scene_location_input = gr.Textbox(label="Scene Location", value=temporary.scene_location)  # New input added
                ...
                save_configuration_btn.click(
                    fn=lambda new_agent_name, new_agent_role, new_human_name, new_scene_location, new_session_history, new_threads_percent, new_image_size, new_steps_used, new_sample_method: update_keys(
