...
5. Now in he browser interface, where the buttons do what you would expect, and most desired options are available.
6. After finishing your session, then click on `Exit Program` button, then close browser tab, the background script then shutdown. 
