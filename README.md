...
- Testing models; sdxl Lightning in Gguf does not work, nor the one from the other dude. Trying sd3.5 large/large_turbo now, `https://huggingface.co/gpustack/stable-diffusion-v3-5-large-GGUF/tree/main` and `https://huggingface.co/gpustack/stable-diffusion-v3-5-large-turbo-GGUF/tree/main`.
