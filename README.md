...
- It was implemented, but then stable diffusion cannot load the newer models, and sdxl not able to do it in 4 steps. Solution is to use llama-box, this tool will be able to load both, text and image, models; re-implementing interference method.
